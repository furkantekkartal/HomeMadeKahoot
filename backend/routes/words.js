...
router.put('/sources/:sourceId', auth, wordController.updateSource);
console.log('✓ Route registered: PUT /api/words/sources/:sourceId');
router.delete('/sources/:sourceId', auth, wordController.deleteSource);
console.log('✓ Route registered: DELETE /api/words/sources/:sourceId');
